...
namespace CODE955\inc;

use CODE955\Inc\Traits\Singleton;
...
class Menus {
	...
	public function register_menus() {
		register_nav_menus([
			'code955-header-menu' => esc_html__( 'Header Menu', 'code955' ),
			'code955-footer-menu' => esc_html__( 'Footer Menu', 'code55' ),
		]);
	}
